...
import terminalDockDark from '@assets/whats-new/aspire-13.6.0/terminal-dock-dark.png';
import terminalDockLight from '@assets/whats-new/aspire-13.6.0/terminal-dock-light.png';
import terminalInteractionDark from '@assets/whats-new/aspire-13.6.0/terminal-interaction-dark.png';
import terminalInteractionLight from '@assets/whats-new/aspire-13.6.0/terminal-interaction-light.png';
...
<ThemeImage
  dark={terminalDockDark}
  light={terminalDockLight}
  alt="Aspire 13.6 resources page with AppHost-owned Workspace and Catalog checks terminal tabs in the dock."
/>
...
<ThemeImage
  ...
  alt="Aspire 13.6 terminal interaction dialog running and completing a local configuration workflow."
/>
